...
def _build_prompt(question: str) -> str:
    ...
    return f"""You are the orb, answering an ad-hoc question from the user over text message.
...
Respond with a plain-text message reply. No JSON, no code blocks, no preamble.
